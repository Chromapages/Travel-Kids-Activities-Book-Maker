      ...
      <div className="relative z-10 border-[12px] border-double border-slate-900 flex-grow rounded-[2.5rem] p-12 flex flex-col items-center justify-center bg-white/40 backdrop-blur-md shadow-inner">
        ...
        <div className="space-y-8 w-full">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl font-medium text-slate-400 uppercase tracking-[0.4em] leading-tight">Young Explorers</h1>
            <h2 className="text-7xl font-comic font-medium text-slate-900 leading-none tracking-tighter mb-4">
              GUIDE
            </h2>
          </div>
          ...
          <div className="py-10">
            <div className="inline-block relative">
              ...
              <div className="relative text-5xl md:text-6xl font-comic font-medium text-indigo-600 p-4 transform rotate-1">
                {meta.destinationCity ? `${meta.destinationCity}` : meta.destinationCountry}
              </div>
            </div>
            {meta.destinationCity && (
              <div className="text-2xl font-medium text-slate-400 mt-2 uppercase tracking-widest">{meta.destinationCountry}</div>
            )}
          </div>
        </div>
        ...
        <div className="mt-auto w-full">
          ...
          <p className="text-slate-400 font-medium text-xs uppercase tracking-[0.5em]">Global Traveler Edition</p>
        </div>
